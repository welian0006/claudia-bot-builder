      ...
      return utils.apiGatewayPromise.getStagePromise({
        ...
        if (options['configure-fb-bot']) {
          ...
          .then(() => {
            ...
            console.log(`\nFollowingxyz info is required for the setup, for more info check the documentation.\n`);
          ...
          .then(() => rp.post(`https://graph.facebook.com/v2.6/me/subscribed_apps?subscribed_fields=messages,messaging_postbacks&access_token=${pageAccessToken}`));
        }
      });
    })
